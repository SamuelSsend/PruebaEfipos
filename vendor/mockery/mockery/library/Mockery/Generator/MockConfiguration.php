...
class MockConfiguration
{
    ...
    public function getMethodsToMock()
    {
        ...
        if ($whiteListedMethods !== []) {
            ...
            return array_filter(
                $methods, static function ($method) use ($whitelist) {
        ...
        if ($blackListedMethods !== []) {
            ...
            $methods = array_filter(
                $methods, static function ($method) use ($blacklist) {
        ...
        if ($targetClass !== null
            ...
            $methods = array_filter(
                $methods, static function ($method) {
    ...
    protected function getAllMethods()
    {
        ...
        $names = [];
        $methods = array_filter(
            $methods, static function ($method) use (&$names) {
