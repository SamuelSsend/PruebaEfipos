...
class ArtisanServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    {
        $this->app->singleton(
            'command.cast.make', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.channel.make', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.component.make', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.event.clear', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.observer.make', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.optimize.clear', function () {
    ...
    {
        $this->app->singleton(
            'command.package.discover', function () {
    ...
    {
        $this->app->singleton(
            'command.queue.monitor', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.queue.prune-batches', function () {
    ...
    {
        $this->app->singleton(
            'command.queue.prune-failed-jobs', function () {
    ...
    {
        $this->app->singleton(
            'command.queue.restart', function ($app) {
    ...
    {
        $this->app->singleton(
            'command.queue.retry-batch', function () {
    ...
    {
        $this->app->singleton(
            'command.queue.batches-table', function ($app) {
