...
class Factory
{
    ...
    public function fake($callback = null)
    {
        ...
        $this->stubCallbacks = $this->stubCallbacks->merge(
            collect(
                [
    ...
    {
        return tap(
            $this->sequence(), function ($sequence) use ($url) {
    ...
    {
        return $this->fake(
            function ($request, $options) use ($url, $callback) {
    ...
    public function recorded($callback = null)
    {
        ...
        return collect($this->recorded)->filter(
            function ($pair) use ($callback) {
    ...
    public function __call($method, $parameters)
    {
        ...
        return tap(
            $this->newPendingRequest(), function ($request) {
