...
class MailFake implements Factory, Mailer, MailQueue
{
    ...
    public function sent($mailable, $callback = null)
    {
        ...
        return $this->mailablesOf($mailable)->filter(
            function ($mailable) use ($callback) {
    ...
    public function queued($mailable, $callback = null)
    {
        ...
        return $this->queuedMailablesOf($mailable)->filter(
            function ($mailable) use ($callback) {
                return $callback($mailable);
            }
        );
    ...
    {
        return collect($this->mailables)->filter(
            function ($mailable) use ($type) {
    ...
    {
        return collect($this->queuedMailables)->filter(
            function ($mailable) use ($type) {
                return $mailable instanceof $type;
            }
        );
