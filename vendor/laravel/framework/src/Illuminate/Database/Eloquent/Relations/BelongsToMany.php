...
class BelongsToMany extends Relation
{
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return tap(
            $this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    public function simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return tap(
            $this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
                $this->hydratePivotRelation($paginator->items());
            }
        );
    }
    ...
    public function cursorPaginate($perPage = null, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
    {
        ...
        return tap(
            $this->query->cursorPaginate($perPage, $columns, $cursorName, $cursor), function ($paginator) {
                $this->hydratePivotRelation($paginator->items());
            }
        );
    }
    ...
    {
        return $this->prepareQueryBuilder()->chunk(
            $count, function ($results, $page) use ($callback) {
    ...
    {
        return $this->prepareQueryBuilder()->lazy($chunkSize)->map(
            function ($model) {
    ...
    public function lazyById($chunkSize = 1000, $column = null, $alias = null)
    {
        ...
        return $this->prepareQueryBuilder()->lazyById($chunkSize, $column, $alias)->map(
            function ($model) {
                $this->hydratePivotRelation([$model]);
    ...
    {
        return $this->prepareQueryBuilder()->cursor()->map(
            function ($model) {
                $this->hydratePivotRelation([$model]);
    ...
    protected function hydratePivotRelation(array $models)
    {
        ...
        foreach ($models as $model) {
            $model->setRelation(
                $this->accessor, $this->newExistingPivot(
