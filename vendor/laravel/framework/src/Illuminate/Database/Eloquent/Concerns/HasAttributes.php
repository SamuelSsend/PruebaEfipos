...
trait HasAttributes
{
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        return tap(
            $relation->getResults(), function ($results) use ($method) {
    ...
    {
        return tap(
            $this->getArrayAttributeByKey($key), function (&$array) use ($path, $value) {
    ...
    protected function getOriginalWithoutRewindingModel($key = null, $default = null)
    {
        ...
        return collect($this->original)->mapWithKeys(
            function ($value, $key) {
    ...
    protected static function getAttributeMarkedMutatorMethods($class)
    {
        ...
        return collect((new ReflectionClass($instance))->getMethods())->filter(
            function ($method) use ($instance) {
