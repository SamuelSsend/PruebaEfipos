...
class Builder
{
    ...
    protected function addArrayOfWheres($column, $boolean, $method = 'where')
    {
        return $this->whereNested(
            function ($query) use ($column, $method, $boolean) {
    ...
    protected function ensureOrderForCursorPagination($shouldReverse = false)
    {
        ...
        return collect($this->orders ?? $this->unionOrders ?? [])->filter(
            ...
            $shouldReverse, function (Collection $orders) {
                    return $orders->map(
                        function ($order) {
    ...
    {
        return tap(
            $this->clone(), function ($clone) use ($properties) {
    ...
    {
        return tap(
            $this->clone(), function ($clone) use ($except) {
