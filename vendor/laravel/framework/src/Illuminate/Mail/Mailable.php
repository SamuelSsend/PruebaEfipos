...
class Mailable implements MailableContract, Renderable
{
    ...
    {
        $this->withLocale(
            $this->locale, function () use ($mailer) {
                ...
                return $mailer->send(
                    $this->buildView(), $this->buildViewData(), function ($message) {
    ...
    protected function hasRecipient($address, $name = null, $property = 'to')
    {
        ...
        return collect($this->{$property})->contains(
    ...
    protected function renderForAssertions()
    {
        ...
        return $this->assertionableRenderStrings = $this->withLocale(
            $this->locale, function () {
                Container::getInstance()->call([$this, 'build']);
