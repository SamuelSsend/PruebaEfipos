<div class="trace trace-as-html" id="trace-box-<?php echo $index; ?>">
    <div class="trace-details">
        <div class="trace-head">
            <div class="sf-toggle" data-toggle-selector="#trace-html-<?php echo $index; ?>" data-toggle-initial="<?php echo $expand ? 'display' : ''; ?>">
                ...
                <?php } else { ?>
                    <h3 class="trace-class">
                        <?php if ('' !== $namespace) { ?>
                            <span class="trace-namespace"><?php echo $namespace; ?></span>
                        <?php } ?>
                        <?php echo $class; ?>
                    </h3>
                <?php } ?>
