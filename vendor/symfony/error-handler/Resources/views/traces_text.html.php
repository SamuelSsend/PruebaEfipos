<table class="trace trace-as-text">
    <thead class="trace-head">
        <tr>
            <th class="sf-toggle" data-toggle-selector="#trace-text-<?php echo $index; ?>" data-toggle-initial="<?php echo 1 === $index ? 'display' : ''; ?>">
                <div class="trace-class">
                    <?php if ($numExceptions > 1) { ?>
                        <span class="text-muted">[<?php echo $numExceptions - $index + 1; ?>/<?php echo $numExceptions; ?>]</span>
                    <?php } ?>
    ...
    <tbody id="trace-text-<?php echo $index; ?>">
        <tr>
            <td>
