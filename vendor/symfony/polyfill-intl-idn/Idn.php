...
final class Idn
{
    ...
    private static function isValidContextJ(array $codePoints, $label)
    {
        if (!isset(self::$virama)) {
            self::$virama = include __DIR__.\DIRECTORY_SEPARATOR.'Resources'.\DIRECTORY_SEPARATOR.'unidata'.\DIRECTORY_SEPARATOR.'virama.php';
        }
    ...
    private static function lookupCodePointStatus($codePoint, $useSTD3ASCIIRules)
    {
        if (!self::$mappingTableLoaded) {
            ...
            self::$mapped = include __DIR__.'/Resources/unidata/mapped.php';
            self::$ignored = include __DIR__.'/Resources/unidata/ignored.php';
            self::$deviation = include __DIR__.'/Resources/unidata/deviation.php';
            self::$disallowed = include __DIR__.'/Resources/unidata/disallowed.php';
            self::$disallowed_STD3_mapped = include __DIR__.'/Resources/unidata/disallowed_STD3_mapped.php';
            self::$disallowed_STD3_valid = include __DIR__.'/Resources/unidata/disallowed_STD3_valid.php';
        }
