...
class SFTP extends SSH2
{
    ...
    public function realpath($path)
    {
        ...
        if ($this->pwd === true) {
            ...
            default:
                throw new \UnexpectedValueException(
                    'Expected NET_SFTP_NAME or NET_SFTP_STATUS. '
                        . 'Got packet type: ' . $this->packet_type
                );
            }
        }
    ...
    public function chdir($dir)
    {
        ...
        default:
            throw new \UnexpectedValueException(
                'Expected NET_SFTP_HANDLE or NET_SFTP_STATUS' .
                    'Got packet type: ' . $this->packet_type
            );
        }
    ...
    private function stat_helper($filename, $type)
    {
        ...
        throw new \UnexpectedValueException(
            'Expected NET_SFTP_ATTRS or NET_SFTP_STATUS. '
            . 'Got packet type: ' . $this->packet_type
        );
    }
            ...
            while ($i > 0) {
                ...
                default:
                    ...
                    if ($this->channel_close) {
                        ...
                        throw new \UnexpectedValueException(
                            'Expected NET_SFTP_DATA or NET_SFTP_STATUS. '
                                                          . 'Got packet type: ' . $this->packet_type
                        );
                    }
                }
