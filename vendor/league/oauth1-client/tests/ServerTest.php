...
class ServerTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        include_once __DIR__ . '/stubs/ServerStub.php';
    }
    ...
    public function testGettingTemporaryCredentials()
    {
        ...
        $client->shouldReceive('post')->with(
            'http://www.example.com/temporary', m::on(
    ...
    public function testGettingTokenCredentials()
    {
        ...
        $me = $this;
        $client->shouldReceive('post')->with(
            'http://www.example.com/token', m::on(
                function ($options) use ($me) {
                    $headers = $options['headers'];
    ...
    public function testGettingTokenCredentialsWithUserAgent()
    {
        ...
        $client->shouldReceive('post')->with(
            'http://www.example.com/token', m::on(
                function ($options) use ($me, $userAgent) {
                    $headers = $options['headers'];
                    $body = $options['form_params'];
    ...
    public function testGettingUserDetails()
    {
        ...
        $client->shouldReceive('get')->with(
            'http://www.example.com/user', m::on(
                function ($options) use ($me) {
                    $headers = $options['headers'];
