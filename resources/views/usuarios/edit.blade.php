                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" class="form-control form-control-prepended" placeholder="Introducir nombre" name="name" value="{{$user->name}}">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control"  placeholder="Introducir dirección" name="direccion" value="{{$user->direccion}}">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control"  placeholder="Introducir nº de teléfono" name="telefono" value="{{$user->telefono}}">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group input-group-merge" id="show_hide_password">
                              <input type="password" class="form-control form-control-prepended" placeholder="Introducir contraseña"  name="password_confirmation" >
                              <div class="input-group-prepend">
                                <div class="input-group-text" style="padding-right: 0px;padding:0px !important">
                                  <button type="button" id="btn-pass" class="btn btn-primary" style="border-bottom-width: 0px;"><span class="fe fe-lock"></span></button>
                                </div>
